...
// Keep the marketing home eager for LCP; everything else splits by route.
...
const BusinessOperationsHub = lazy(() =>
  import('./pages/public/ServiceHubs').then((m) => ({ default: m.BusinessOperationsHub })),
)
const PropertyFieldHub = lazy(() =>
  import('./pages/public/ServiceHubs').then((m) => ({ default: m.PropertyFieldHub })),
)
const MobileDocumentHub = lazy(() =>
  import('./pages/public/ServiceHubs').then((m) => ({ default: m.MobileDocumentHub })),
)
const CarePlans = lazy(() => import('./pages/public/CarePlans'))
const CarePlansConfirmation = lazy(() =>
  import('./pages/public/CarePlans').then((m) => ({ default: m.CarePlansConfirmation })),
)
...
function PublicFallback() {
  return <SurfaceFallback label="Loading…" />
}
...
if (surface === 'admin') {
  ...
  if ('serviceWorker' in navigator) {
    window.addEventListener('load', () => {
      void navigator.serviceWorker.register('/sw-hq.js').catch(() => {})
    })
  }
}
