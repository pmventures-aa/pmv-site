import {
  ...
  BookOpen, Bot, Gauge, type LucideIcon,
} from 'lucide-react'

export interface NavItem { key:string;label:string;to:string;icon:LucideIcon;section?:string;externalHref?:string }
...
export const adminNav: NavItem[] = [
  ...
  {key:'messages',label:'Inbox',to:'messages',icon:MessageSquare,section:'Operations'},{key:'communications',label:'Email Studio',to:'communications',icon:Megaphone,section:'Operations',externalHref:'https://mail.pinnaclemanagementventures.com/email'},{key:'automation-center',label:'Automation Center',to:'automation-center',icon:Bot,section:'Operations'},{key:'document-center',label:'Document Hub',to:'document-center',icon:FileText,section:'Operations'},{key:'community-documents',label:'Community Docs',to:'community-documents',icon:BookOpen,section:'Operations'},{key:'envelopes',label:'Signing Studio',to:'envelopes',icon:Send,section:'Operations',externalHref:'https://mail.pinnaclemanagementventures.com/signing'},{key:'field-work',label:'Field Work & RON',to:'field-work',icon:MapPinned,section:'Operations'},
