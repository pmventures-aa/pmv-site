import {
  ...
  BookOpen, Bot, Gauge, PenTool, Wrench, ShieldCheck, Globe, MailPlus, Bell, KeyRound, Inbox, type LucideIcon,
} from 'lucide-react'
...
export const adminNav: NavItem[] = [
  ...
  {key:'communications',label:'Communications',to:'communications',icon:Inbox,section:'Operations'},
  ...
  {key:'esign-platform',label:'E-Signature Platform',to:'esign-platform',icon:PenTool,section:'Operations'},
  {key:'community-documents',label:'Community Docs',to:'community-documents',icon:BookOpen,section:'Operations'},
  {key:'envelopes',label:'Signed Documents',to:'envelopes',icon:Send,section:'Operations'},
  ...
  {key:'inquiries',label:'Leads & CRM',to:'inquiries',icon:UserPlus,section:'Administration'},
  {key:'public-funnel',label:'Website Studio',to:'public-funnel',icon:Globe,section:'Administration'},
  {key:'client-banners',label:'Client Banners',to:'client-banners',icon:Bell,section:'Administration'},
