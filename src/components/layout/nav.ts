...
export const adminNav: NavItem[] = [
  ...
  { key: 'inquiries', label: 'Inquiries', to: 'inquiries', icon: '✉', section: 'Workspace' },
  { key: 'messages', label: 'Messages', to: 'messages', icon: '≋', section: 'Workspace' },

  { key: 'activity', label: 'Activity', to: 'activity', icon: '◷', section: 'Operations' },
  { key: 'communications', label: 'Communications', to: 'communications', icon: '◫', section: 'Operations' },
