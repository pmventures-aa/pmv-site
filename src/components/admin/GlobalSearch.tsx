...
interface InvoiceHit { id: string; amount_cents: number; status: string; invoice_number?: string | null; title?: string | null; client_user_id: string; client_name: string | null; client_email: string }
