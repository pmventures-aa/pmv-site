...
export function StatCard({label,value}:{label:string;value:ReactNode}){return <div className="rounded-lg border border-white/[.08] bg-white/[.02] px-4 py-3"><p className="text-[10px] font-bold uppercase tracking-[.14em] text-slate-500">{label}</p><p className="mt-1.5 text-2xl font-bold tracking-[-.03em] text-white tabular-nums">{value}</p></div>}
