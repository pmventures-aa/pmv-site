    ...
    <footer className="border-t border-white/5 bg-navy-950/60">
      <div className="container-pmv py-12">
        <div className="grid gap-10 md:grid-cols-4">
          <div>
            <Logo />
            <p className="mt-4 max-w-xs text-sm text-slate-400">Professional support for business operations, property work, projects, transitions, and defined mobile services.</p>
            <p className="mt-4 text-xs text-slate-500">Remote services nationwide. On-site services in South Florida.</p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-400">
              {services.map((s) => <li key={s.slug}><Link to={`/services/${s.slug}`} className="hover:text-gold">{s.title}</Link></li>)}
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-400">
              ...
              <li><a href="https://secure.pinnaclemanagementventures.com/login" className="hover:text-gold">Client Login</a></li>
              <li><a href="https://secure.pinnaclemanagementventures.com/hq/login" className="hover:text-gold">Team Login</a></li>
            </ul>
          </div>
        </div>
