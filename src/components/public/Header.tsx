...
export function Header(){
  ...
  >
    <div className="container-pmv flex h-[68px] items-center justify-between gap-4">
      ...
      <div className="hidden items-center gap-2 lg:flex"><a href={CLIENT_LOGIN} className={btnOutline}>Client Sign In</a><a href={CLIENT_SIGNUP} className={btnPrimary}>Request a Service</a></div>
