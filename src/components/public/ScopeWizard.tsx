...
export function ScopeWizard({source='scope-page',compact=false}:{source?:string;compact?:boolean}){
  ...
  const [form,setForm]=useState<Form>({job_type:initialJob,location_type:remoteJobs.has(initialJob)?'remote':'onsite',city:'',state:'',postal_code:'',timing:'',details:'',contact_name:'',email:'',phone:'',follow_up_opt_in:false,website:''})
