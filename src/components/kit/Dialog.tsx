...
export function DialogContent({
  ...
  return (
    <RadixDialog.Portal>
      ...
      <RadixDialog.Content
        className={`fixed left-1/2 top-1/2 z-50 w-[calc(100%-2rem)] max-w-md -translate-x-1/2 -translate-y-1/2 rounded-md border border-white/10 bg-navy-900 p-6 shadow-2xl focus:outline-none ${className}`}
      >
