...
export default function FieldWorkDetail() {
  ...
  return (
    <div>
      <button
        type="button"
        onClick={() => navigate(p(workspace.party_type === 'vendor' ? 'field-work/mine' : 'field-work'))}
            ...
            {done ? (
              ...
              <div className="mt-3 space-y-4">
                ...
                <button
                  ...
                  className={`${btnPrimary} sticky bottom-[calc(4.75rem+env(safe-area-inset-bottom))] z-20 w-full !min-h-12 !py-3 disabled:opacity-60 lg:static lg:bottom-auto`}
                >
