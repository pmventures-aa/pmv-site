  ...
  return (
    <div>
      ...
      <div className="mb-6 grid gap-3 sm:grid-cols-2 xl:grid-cols-4">
        ...
        {caps.is_owner
          ? <Link to={p('roles')} className="group rounded-xl border border-white/[.08] bg-white/[.02] p-4 transition hover:border-gold/25 hover:bg-gold/[.025]"><p className="text-[10px] font-bold uppercase tracking-[.14em] text-slate-500">Access</p><p className="mt-2 flex items-center justify-between text-sm font-extrabold text-white">Roles & Permissions <ChevronRight size={15} className="text-gold transition group-hover:translate-x-0.5" /></p></Link>
