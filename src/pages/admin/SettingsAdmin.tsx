...
import { Bell, BriefcaseBusiness, Building2, CalendarCheck2, CalendarClock, ChevronRight, Files, Palette, Search, Settings2, ShieldCheck, SlidersHorizontal, Trash2, Users } from 'lucide-react'
  ...
  return (
    <div>
      ...
      <div className="mb-6 grid gap-3 sm:grid-cols-2 xl:grid-cols-5">
        ...
        <Link to={p('security-center')} className="group rounded-xl border border-white/[.08] bg-white/[.02] p-4 transition hover:border-gold/25 hover:bg-gold/[.025]"><p className="text-[10px] font-bold uppercase tracking-[.14em] text-slate-500">Security</p><p className="mt-2 flex items-center justify-between text-sm font-extrabold text-white">Sessions & Access <ChevronRight size={15} className="text-gold transition group-hover:translate-x-0.5" /></p></Link>
        <Link to={p('automation-center')} className="group rounded-xl border border-white/[.08] bg-white/[.02] p-4 transition hover:border-gold/25 hover:bg-gold/[.025]"><p className="text-[10px] font-bold uppercase tracking-[.14em] text-slate-500">Operations</p><p className="mt-2 flex items-center justify-between text-sm font-extrabold text-white">Automation Center <ChevronRight size={15} className="text-gold transition group-hover:translate-x-0.5" /></p></Link>
        {caps.is_owner && <Link to={p('roles')} className="group rounded-xl border border-white/[.08] bg-white/[.02] p-4 transition hover:border-gold/25 hover:bg-gold/[.025] sm:col-span-2 xl:col-span-1"><p className="text-[10px] font-bold uppercase tracking-[.14em] text-slate-500">Access</p><p className="mt-2 flex items-center justify-between text-sm font-extrabold text-white">Roles & Permissions <ChevronRight size={15} className="text-gold transition group-hover:translate-x-0.5" /></p></Link>}
      </div>
