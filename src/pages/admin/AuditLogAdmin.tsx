...
export default function AuditLogAdmin() {
  ...
  if(!caps.loading&&!caps.can_view_audit_log)return <div><PageIntro section="Administration" kicker="Compliance" title="Audit Log"/><NoAccess label="the Audit Log"/></div>
  return <div>
