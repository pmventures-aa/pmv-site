...
export default function InvitationsAdmin() {
  ...
  return <div>
    ...
    {showForm && <Panel className="mb-6 !border-gold/25 !p-0"><form onSubmit={send}><div className="border-b border-white/10 px-5 py-4 sm:px-6"><p className="eyebrow">New invitation</p><h2 className="mt-2 text-xl font-semibold text-white">Invite the relationship, not a rigid account type</h2><p className="mt-2 text-sm leading-6 text-slate-400">For providers, anything you already know personalizes the email and prefills the application. The recipient can still correct it, add services, or register a business.</p></div><div className="grid lg:grid-cols-[minmax(0,1.35fr)_minmax(300px,.65fr)]"><div className="space-y-6 p-5 sm:p-6">
