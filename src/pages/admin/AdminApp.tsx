...
const STAFF_VISIBLE = ['dashboard','pipelines','clients','inquiries','quotes','messages','cases','calendar','activity','invoices','field-work','service-assignments','security-center']
