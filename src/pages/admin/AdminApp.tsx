...
const StaffInvite = lazy(() => import('../auth/StaffInvite'))
...
const FieldWorkVendor = lazy(() => import('./FieldWorkVendor'))
...
function AdminIndex(){
  ...
  return <Lazy><AdminDashboard/></Lazy>
}
...
// Named export lives on the same module as the default detail page.
const FieldWorkVendorList = lazy(() =>
  import('./FieldWorkVendor').then((m) => ({ default: m.FieldWorkList })),
)

export default function AdminApp({basePath}:{basePath:string}){
  return <BasePathProvider base={basePath}><Routes>
    <Route path="login" element={<Lazy><Login surface="staff"/></Lazy>}/>
    <Route path="forgot-password" element={<Lazy><ForgotPassword surface="staff"/></Lazy>}/>
    <Route path="reset-password" element={<Lazy><ResetPassword surface="staff"/></Lazy>}/>
    <Route path="set-password" element={<Lazy><SetPassword surface="staff"/></Lazy>}/>
    <Route path="vendor-signup" element={<Lazy><VendorSignup/></Lazy>}/>
    <Route path="invite/:token" element={<Lazy><StaffInvite/></Lazy>}/>
    <Route element={<ProtectedRoute allow={['staff','admin']}/>}><Route element={<AdminShell/>}>
      <Route index element={<AdminIndex/>}/>
      <Route path="pipelines" element={<Lazy><PipelinesAdmin/></Lazy>}/>
      <Route path="clients" element={<Lazy><ClientsList/></Lazy>}/>
      <Route path="clients/:id" element={<Lazy><ClientDetailModern/></Lazy>}/>
      <Route path="clients/:id/:section" element={<Lazy><ClientDetailModern/></Lazy>}/>
      <Route path="clients/:id/manage" element={<Lazy><ClientDetail/></Lazy>}/>
      <Route path="inquiries" element={<Lazy><CRMRecordsAdmin/></Lazy>}/>
      <Route path="leads/new" element={<Lazy><LeadCreate/></Lazy>}/>
      <Route path="leads/:id" element={<Lazy><LeadDetail/></Lazy>}/>
      <Route path="leads/:id/:section" element={<Lazy><LeadDetail/></Lazy>}/>
      <Route path="messages" element={<Lazy><MessagesAdmin/></Lazy>}/>
      <Route path="cases" element={<Lazy><CasesAdmin/></Lazy>}/>
      <Route path="activity" element={<Lazy><ActivityAdmin/></Lazy>}/>
      <Route path="service-assignments" element={<Lazy><ServiceAssignmentsAdmin/></Lazy>}/>
      <Route path="field-work" element={<Lazy><FieldWorkAdmin/></Lazy>}/>
      <Route path="field-work/mine" element={<FieldWorkListPage/>}/>
      <Route path="field-work/:id" element={<FieldWorkDetailPage/>}/>
      <Route path="invoices" element={<Lazy><InvoicesAdmin/></Lazy>}/>
      <Route path="quotes" element={<Lazy><QuotesAdmin/></Lazy>}/>
      <Route path="document-center" element={<Lazy><DocumentOperationsDashboard/></Lazy>}/>
      <Route path="esign-platform" element={<Lazy><ESignPlatformAdmin/></Lazy>}/>
      <Route path="community-documents" element={<Lazy><CommunityDocuments/></Lazy>}/>
      <Route path="envelopes" element={<Lazy><EnvelopeWorkspaceEnterprise/></Lazy>}/>
      <Route path="audit-log" element={<Lazy><AuditLogAdmin/></Lazy>}/>
      <Route path="management" element={<Lazy><ManagementCenter/></Lazy>}/>
      <Route path="reports" element={<Lazy><ReportingCenter/></Lazy>}/>
      <Route path="communications" element={<RedirectToMessages tab="email"/>}/>
      <Route path="communications/email" element={<Lazy><CommunicationsCRMAdmin/></Lazy>}/>
      <Route path="client-banners" element={<Lazy><ClientBannersAdmin/></Lazy>}/>
      <Route path="automation-center" element={<Lazy><AutomationCenter/></Lazy>}/>
      <Route path="public-funnel" element={<Lazy><PublicFunnelAdmin/></Lazy>}/>
      <Route path="security-center" element={<Lazy><SecurityCenter/></Lazy>}/>
      <Route path="network" element={<Lazy><ProviderNetworkAdmin/></Lazy>}/>
      <Route path="network/:id/:section" element={<Lazy><ProviderProfile/></Lazy>}/>
      <Route path="employees" element={<Navigate to="../network" replace/>}/>
      <Route path="open-items/:type" element={<Lazy><OpenItemsAdmin/></Lazy>}/>
      <Route path="open-items" element={<Lazy><OpenItemsAdmin/></Lazy>}/>
      <Route path="invitations" element={<Lazy><InvitationsAdmin/></Lazy>}/>
      <Route path="roles" element={<Lazy><RolesPermissionsAdmin/></Lazy>}/>
      <Route path="users" element={<Lazy><UsersAdmin/></Lazy>}/>
      <Route path="assignments" element={<Lazy><AssignmentsAdmin/></Lazy>}/>
      <Route path="settings" element={<Lazy><SettingsAdmin/></Lazy>}/>
