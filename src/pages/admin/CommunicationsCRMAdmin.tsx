...
export default function CommunicationsCRMAdmin() {
  ...
  return <div className="mx-auto max-w-[1600px]">
    ...
    <Dialog open={composeOpen} onOpenChange={setComposeOpen}>
      <DialogContent title="New email" description="Compose a professional message and select the exact audience, delivery time, and communication type.">
