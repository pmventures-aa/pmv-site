...
const STEPS = [
  ...
  { title: 'The checklist gets done', body: 'Every room on a tracked checklist, required photos, and a final walkthrough. Issues are flagged the moment they show up, with photos rather than surprises later.' },
        ...
        <section id="packages" className="border-b border-white/[.08]">
          <div className="container-pmv py-14 sm:py-18">
            <Reveal className="max-w-3xl" distance={14}>
              ...
              <p className="mt-4 text-sm leading-7 text-slate-400">Every package includes the tracked checklist, required photos, issue flagging, independent verification, and the portal report. Pricing is quoted in writing for your property, with no hidden per-supply fees.</p>
            </Reveal>
