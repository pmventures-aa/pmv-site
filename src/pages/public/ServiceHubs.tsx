...
const HUBS: Record<'business'|'property'|'mobile', HubConfig> = {
  ...
  property: {
    eyebrow: 'Property & Field',
    title: 'A dependable local presence when the work is happening on site.',
    intro: 'Property work often becomes difficult because the owner, vendor, tenant, office, and field are all operating from different information. Pinnacle helps keep the assignment connected.',
    statement: 'South Florida field coverage can stand on its own or support a larger business, property, or client engagement.',
    serviceSlugs: ['property-management','property-inspections'],
    themes: [
      ['Owner support','A local point of contact for follow-up, vendor coordination, documentation, and practical property needs.'],
      ['Field verification','Current observations, photos, and reporting when you need to know what is happening at a site.'],
      ['Vendor coordination','Scheduling, access, communication, documentation, and follow-through around property work.'],
      ['Project visibility','Keep field activity connected to the broader client record instead of losing context in texts and calls.'],
    ],
    metaTitle: 'Property & Field Services',
    metaDescription: 'South Florida property owner support, field coordination, property inspections, vendor follow-up, and documented site services.',
  },
  mobile: {
    eyebrow: 'Documents & Mobile',
    title: 'Defined local services for work that cannot stay behind a desk.',
    intro: 'When a document, signer, office, or destination requires someone to physically handle the next step, Pinnacle can coordinate the assignment and keep the confirmation connected to the client.',
    ...
    serviceSlugs: ['mobile-notary','document-courier'],
    themes: [
      ...
      ['Part of a larger engagement','Use mobile work on its own or alongside a property, business, or administrative project.'],
    ],
