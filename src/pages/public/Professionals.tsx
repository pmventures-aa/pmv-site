...
export default function Professionals(){
  ...
  return <div className="min-h-screen bg-navy-950"><Header/><main>
    ...
    <section className="container-pmv pb-14 sm:pb-16"><Reveal className="border-l-2 border-gold bg-white/[.02] px-6 py-5"><p className="eyebrow">Already invited?</p><h2 className="mt-2 text-xl font-semibold text-white">Use the private application link in your email.</h2><p className="mt-2 max-w-3xl text-sm leading-6 text-slate-400">An invitation connects your application to information Pinnacle may have already discussed with you. If the link expires before you finish, Pinnacle can issue a new one.</p><Link to="/provider-agreement" className="mt-3 inline-flex text-sm font-semibold text-gold hover:text-gold-300">Review the Provider Network Agreement →</Link></Reveal></section>
