...
export default function About(){
  ...
  return <div className="min-h-screen bg-navy-950"><Header/><main>
    <section className="pmv-hero-story relative overflow-hidden border-b border-white/10"><div className="pmv-hero-gold" aria-hidden="true"/><div className="container-pmv py-16 sm:py-20"><Reveal className="grid gap-10 lg:grid-cols-[1.05fr_.95fr] lg:items-center"><div><p className="eyebrow">About Pinnacle</p><h1 className="mt-4 max-w-4xl font-display text-4xl font-medium leading-[1.06] text-white sm:text-6xl">Professional Support Built Around <span className="pmv-gold-text">Follow-Through.</span></h1><p className="mt-6 max-w-2xl text-lg leading-relaxed text-slate-300">Pinnacle helps businesses, property owners, and individuals get business, property, and administrative matters handled through one trusted point of contact.</p><p className="mt-4 max-w-2xl text-base leading-7 text-slate-400">We exist because capable people lose too much time coordinating disconnected providers, repeating context, chasing updates, and figuring out who owns the next step.</p><div className="mt-8 flex flex-wrap gap-3"><Link to={GET_HELP} className={btnPrimary}>Tell Us What You Need Help With</Link><Link to="/services" className={btnOutline}>Explore Services</Link></div></div><div className="relative flex min-h-[330px] items-center justify-center"><BrandMark3D size={196} decorative variant="quiet" className="relative z-10"/></div></Reveal></div></section>
