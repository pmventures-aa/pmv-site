...
export default function About(){
  ...
  return <div className="min-h-screen bg-navy-950"><Header/><main>
    ...
    <CtaBand title="Have something that needs attention?" body="Start with the situation, not the service name. We can help determine the right scope and next step." primary={{to:'/portal/signup',label:'Tell Us What You Need'}} secondary={{to:'/services',label:'View Services'}}/>
  </main><Footer/></div>
}
