...
export default function ServiceApplication() {
  ...
  async function submit() {
    ...
    setError(null)
    try {
      const payload: Record<string, unknown> = { answers, current_step: pageIdx }
      ...
      <div className="mx-auto max-w-3xl">
        ...
        <Card className="relative overflow-hidden !p-0">
          <div className="px-5 py-6 sm:px-8 sm:py-8">
            {page?.type === 'intro' && (
              <div>
                ...
                <div className="mt-5 inline-flex items-center gap-2 rounded-full border border-gold/20 bg-gold/10 px-3 py-1.5 text-xs font-medium text-gold">
          ...
          <div className="flex flex-col-reverse gap-3 border-t border-white/10 bg-navy-950/45 px-5 py-4 sm:flex-row sm:items-center sm:justify-between sm:px-8">
            ...
            {page?.type === 'review' ? (
              <button type="button" onClick={() => void submit()} disabled={busy || !!uploadingKey} className="btn-gold disabled:opacity-60">
