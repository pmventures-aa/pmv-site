...
export default function Support() {
  ...
  const [showForm, setShowForm] = useState(!!params.get('property') || !!params.get('subject'))
  const [form, setForm] = useState({ subject: params.get('subject') || '', category: params.get('category') || 'general', priority: 'normal', details: params.get('details') || '', service_key: '', property_id: params.get('property') || '' })
