...
export const serviceOfferings: ServiceOffering[] = [
  ...
  o('property-tenant-placement','property_management','Tenant Placement (Lease-Only)','Marketing and listing coordination, showings, screening, lease preparation, and move-in coordination for owners who plan to self-manage after placement.',undefined,{pricingLabel:'Custom management proposal',badge:'Management tier',note:'Availability and scope depend on applicable Florida licensing and the final written agreement.'}),
  o('property-full-management','property_management','Full Property Management','Ongoing rent collection, maintenance coordination, routine inspections, owner reporting, tenant communication, renewals, and day-to-day follow-through.',undefined,{pricingLabel:'Custom management proposal',badge:'Management tier',note:'Provided only within the applicable licensed scope and final written management agreement.'}),
  o('property-portfolio','property_management','Premium / Portfolio Support','Enhanced reporting, priority maintenance coordination, annual planning, dedicated relationship oversight, and eviction-protection coordination for multi-property owners.',undefined,{pricingLabel:'Custom portfolio proposal',badge:'Portfolio'}),
  ...
  o('property-standard-clean','property_management','Property Cleaning','Routine cleaning for an eligible residence, rental, office, or defined property area, scoped by size and condition.',undefined,{pricingLabel:'Custom quote',badge:'Popular'}),
  o('property-deep-clean','property_management','Deep Cleaning Service','Detailed top-to-bottom cleaning for properties that need more than routine service, with scope confirmed before scheduling.',undefined,{pricingLabel:'Custom quote',badge:'Popular'}),
  o('property-moveout-clean','property_management','Move-Out / Turnover Cleaning','Cleaning coordinated for a tenant move-out, new occupancy, listing, or property handoff, with optional completion photos.',undefined,{pricingLabel:'Custom quote'}),
  o('property-reo-clean','property_management','REO / Vacant Property Cleaning','Interior cleaning and ready-to-market support for authorized vacant or bank-owned properties.',undefined,{pricingLabel:'Custom quote',badge:'REO'}),
  o('property-trashout','property_management','Trash-Out & Debris Removal Coordination','Scope, schedule, access, and completion documentation for removal of abandoned contents or property debris.',undefined,{pricingLabel:'Custom quote'}),
  o('property-preservation','property_management','Vacant Property Preservation Visit','Defined securing, condition, exterior-maintenance, hazard, posting, or preservation tasks with photo documentation.',undefined,{pricingLabel:'Custom quote',badge:'REO'}),
  o('property-eviction-admin','property_management','Eviction Administrative Support','Organize owner records, prepare permitted client-directed paperwork, coordinate service or filing, and track process milestones.',undefined,{pricingLabel:'Scope-based',note:'Not legal advice. Final scope is subject to Florida law and may require a licensed attorney.'}),
  o('property-lockout-turnover','property_management','Writ / Lockout & Post-Possession Turnover Coordination','Coordinate authorized participants, access, locksmith or vendor scheduling, property documentation, cleaning, debris, and securing after lawful possession.',undefined,{pricingLabel:'Custom quote',note:'Available only after lawful authorization and in coordination with the appropriate officials or legal professionals.'}),
  ...
  o('document-form-prep','admin_support','Client-Directed Form & Document Preparation','Prepare or format a defined non-lawyer document from client-provided information and instructions.',undefined,{pricingLabel:'Starting at $95',badge:'Document support',note:'Pinnacle does not provide legal advice or select legal rights or remedies for a client.'}),
  o('document-property-packet','admin_support','Property / Landlord Document Packet','Organize leases, ledgers, notices, photos, correspondence, and other owner records into a clear working packet.',195,{pricingLabel:'Starting at $195'}),
  o('document-filing-package','admin_support','Filing-Ready Administrative Package','Assemble client-provided and permitted documents, required copies, cover materials, and delivery instructions for a defined filing.',195,{pricingLabel:'Starting at $195',note:'Filing fees and third-party charges are additional. Attorney review may be required.'}),
