...
- **Auth:** Email + password (PBKDF2-SHA256, HMAC-peppered), opaque KV-backed sessions; optional Auth0 Universal Login for the client portal (Google/Microsoft) that maps to the same Pinnacle session
