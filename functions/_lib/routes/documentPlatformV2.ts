...
import { requireOwner as requireActualOwner, requireStaff as requireActualStaff } from '../mid'
...
// Admin access
documentPlatformV2AdminRoutes.use('/document-platform/*',requireActualStaff)
